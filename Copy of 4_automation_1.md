...
The generative models in chatbots which produce synthetic text are known as Large Language Models (LLMs). LLMs work by predicting the most likely words to follow your prompt, based on patterns recorded in a statistical model created from billions of human-created sources (such as online news articles, Wikipedia, social media posts etc). 
...
#### Protecting privacy
When prompting a model, any information you provide (including highly personal information) is being harvested by the system to create a model of you. Free systems are using all the information your provide to train their model and may repeat information from your prompts in output to other users or hackers.  In addition, many people accidentally publish their interactions, leaving their chats exposed and making them vulnerable to hackers, identity theft, stalkers and other harms. 

You should view GenAI use as a major privacy risk and think carefully about what you disclose in your chats. You should also not upload copyrighted material such as published articles as part of your prompt. 
