...
Much as with traditional media, social media platforms, global technology companies, and AI models also have a great deal of social power. These "big tech" companies are also used by their owners to advance their own commercial and political interests, and to influence which kinds of messages are viewed by their users. 

This conflation of power, wealth, and patriarchy have led to the billionaire owners of "Big Tech", Mark Zuckerberg, Elon Musk and Sam Altman being referred to as the "broligarchy". 

The close relationship between state and tech power became apparent when Mark Zuckerberg, Lauren Sanchez, Jeff Bezos, Sundar Pichai and Elon Musk were seated together at  <a href ="https://www.gettyimages.com/detail/news-photo/of-meta-mark-zuckerberg-lauren-sanchez-us-businessman-jeff-news-photo/2194353829">Donald Trump's inauguration</a> in 2024, creating an iconic image of the close relationship between big tech and economic and political power in the USA.  

TikTok followed Meta and Microsoft into the fold when the US applied pressure for TikTok to be sold by Bytedance to a group of US investors, among them business software giant Oracle.  Larry Ellison, founder of Oracle and another tech billionaire, also has substantial media holdings in the US. 
...
At Meta, a platfom which had banned Donald Trump in 2020, the shift in power after the 2025 inauguration of Trump, was followed by dramatic changes in moderation policies on the platforms, as parodied by US comedian, John Oliver:
