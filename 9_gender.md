...
We’ll also think about how discourses about “gender” (including media texts and also this chapter) are part of **regimes of production of truth** (Foucault, 1972:211). To what extent do the entities we call “men” and “women” come to exist because of the ways we talk about, represent and perform (as) men and women? What role is played by institutions (the family, schools, government, healthcare, marketing, sports etc) in maintaining and producing these and other gendered categories?  Most importantly, what power relations lead us to represent gender in this way?  
...
The **post-structuralist** approach to gender builds on and also challenges the **structuralist** ideas we encountered when we studied **semiotics**. According to De Saussure (a structuralist), language is **a system of differences** where signifiers gain meaning in relation to other signifiers. From this perspective, the relationship between the signifier “woman” and what it signifies is conventional and "arbitrary" (its **referent**). To understand the meaning of the signifier “woman” we need to develop an understanding of how it differs from other signifiers (e.g. “man”). 

Post-structuralist theorists drew our attention to how these relations between signifiers are not fixed but **shift and change**.  In particular, signification changes over time, as historically specific **technologies of power** are used to govern what is included or excluded in discourse and **knowledge**. Foucault (1980:132) argues that what counts as “truth” is mostly governed (though not exclusively so) by socially dominant institutions. For example, he explains that same-sex sexual practices existed throughout history, but the category "homosexual" only came into being in the 19th century when the medical institutions and practices of the time started constructing and regulating knowledge about a phenomenon they were starting to label "homosexuality".  As Foucault explains, “The history which bears and determines us has the form of a war rather than that of a language: relations of power not relations of meaning” ([Foucault, 1980:114](references.html#foucault_1980)).
