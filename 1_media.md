...
{: .question}
What are the most important differences between an AI-generated image of a rhino (see e.g. Figure 3 below) and the Iziko Rhino depicted in [Figure 1](#example---iziko-rhino)? 

<details markdown="block">
<summary>Answer</summary>
The Iziko Rhino is a photograph of an actual historical engraving. The synthetic image generated by DALL-E fabricates a generic bronze sculpture in front of a museum, neither of which exist in Cape Town.
The Iziko Rhino engraving was created by /Xam San people many thousands of years ago for specific cultural purposes which we don't necessarily understand very well today. /Xam society was destroyed by European colonialism and so there are no living people who share this artistic and spiritual tradition and can explain its significance to us. Thus this is a unique engraving of immense historical value. 
By contrast, the synthetic image generated by DALL-E replicates monumental bronze sculptures from the Western tradition which were more likely to be present in its training data. As  DALL-E's training data did not include the Iziko Rhino, it defaults to the Western aesthetic tradition when drawing the rhino. (It may also be reproducing work of artists who did not give permission for their photographs to be used to train the model). 
</details>

{: .activity}
![Activity](img/pencilpencil.svg) How do you feel when you realise that an image or message was fabricated by AI?
